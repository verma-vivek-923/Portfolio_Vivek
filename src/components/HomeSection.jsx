...
const HomeSection = () => {
  return (
    <div className="max-w-screen-2xl flex-col-reverse shadow-sm py-2 container relative items-center justify-center mx-auto px-4 md:px-20">
      <div className="flex flex-col md:flex-row">
        <div className="flex flex-col justify-center order-2 md:order-1 md:ml-12 md:mt-16 w-full md:w-1/2 -translate-y-8 md:translate-y-0">
        ...
        <div className="flex justify-end md:justify-center order-1 items-center md:mt-16 w-ful md:w-1/2">
